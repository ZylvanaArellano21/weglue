-- ============================================================================
-- 103 — message banner delivery through the existing private sync topic
--
...
-- checklist in docs/rollout/migration-103-design.md passes.
-- ============================================================================

-- This is the latest deployed source definition of handle_message_push(),
-- from migration 089. The only behavior added here is the private
-- `new_message` broadcast immediately after each message push enqueue.
