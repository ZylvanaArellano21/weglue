...
MANIFEST = [
    ...
    dict(file="test_149_realtime_sync_block_auth.sql", type="sql", env="stack17",
         chain=None, pg="17.6", setup_role="postgres", assert_role="authenticated / anon (SET ROLE + realtime.topic)",
         criterion="raise",
         note="Private Broadcast receive policy: exact self-topic allow; cross-user, anon, malformed, and unrelated topics deny."),
