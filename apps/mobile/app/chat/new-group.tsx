...
export default function NewGroupScreen() {
  ...
  function next() {
    ...
    // Goes to /chat/new — NOT /chat/new-group. This file IS the static route
    // /chat/new-group, and a static route shadows the dynamic [chatId], so
    // navigating there would just reopen this picker instead of the draft
    // thread. The conversation screen identifies a group draft by the presence
    // of draftParticipantIds, not by the segment.
    router.replace(
      (`/chat/new?` +
