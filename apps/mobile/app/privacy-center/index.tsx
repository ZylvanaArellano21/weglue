  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        {/* Blocked Accounts — the ONLY surface where a block is ever visible,
            and only to the student who created it. */}
        <TouchableOpacity
          style={styles.navRow}
          // `as any` matches the existing convention for routes added since the
          // last typed-route generation: .expo/types/router.d.ts is gitignored
          // and only regenerated by `expo start`, so a freshly added screen is
          // not in it yet. The route itself is verified by the export above.
          onPress={() => router.push('/privacy-center/blocked-accounts' as any)}
          activeOpacity={0.7}
        ...
        >
          ...
          <Ionicons name="chevron-forward" size={20} color={profileColors.textMuted} />
        </TouchableOpacity>
      </ScrollView>
