...
- [`deleted-message-privacy.md`](product/deleted-message-privacy.md) — **authoritative v4 design** for secure deleted-message privacy (state machine, orchestration, report evidence, poll privacy, OTA proof). Design only, not implemented.
