...
export const TERMS_AND_CONDITIONS_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '• We Glue may restrict an account\'s access to the Service — temporarily, until we lift the restriction, or while administrator deletion is pending. We show the affected account a category and specific public reason, while internal administrator notes remain private. A restriction is an access decision: it does not by itself delete your content, and it is separate from any block another user has applied. You can still delete your account while your access is restricted.',
      `• Administrator deletion normally provides a seven-day appeal period. We may use immediate deletion for urgent safety, legal, fraud, or institutional situations. To appeal a restriction or scheduled deletion, contact ${LEGAL_CONTACT_EMAIL} and include your We Glue username.`,
